...
if(.Platform$OS.type == "unix") {
 ...
 for (a_year in years){
    ...
    load(file=file.path(outPath, a_year, "interpolated", "plus",
     ...
     save(aggEffortAlly,file=file.path(outPath,  paste("AggregatedEffortAlly_BottomFishing.RData", sep=""))) 
     ...
     ###----------------------
     ## do a ggplot 
     load(file=file.path(outPath,  paste("AggregatedEffortAlly_BottomFishing.RData"))) # aggEffortAlly
